        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="d-flex justify-content-center">
                <form action="listar2.php" method="post">
                    <div class="col-auto">
                        <label for="tabela" class="form-label"><h5>Nome da Tabela:</h5></label><br>
                        <input type="tabela" class="form-control bg-warning" name="tabela" id = "tabela" aria-describedby="tabelalHelp"><br>
                    </div>
                    <button type="submit" class="btn btn-warning" name="op" value="Listar" >Localizar</button>
                </form>
            </div>
    </body>
</html>